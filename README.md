...
- **Test Tone Generator**: Generate Sine, Square, Sawtooth, Triangle, noise ambiences, sweep, a psychoacoustic creepy mode with low-frequency rumble, and a low-only creepy bass mode. Real-time control of frequency, panning, and gain.
